...
<%
            ...
            int n=0;     
             ...
             con = DriverManager.getConnection("jdbc:mysql://localhost:3306/stock_predection","root","sammu");
		...
		<div class="wrapper">
			<div class="wrapper">
				<ul class="banners">
					...
					<li>
						<a href="#"><img src="https://th.bing.com/th/id/OIP.tu5yvoyO5oYFWYzLVOf-BwHaHa?rs=1&pid=ImgDetMain" height="100px" width="100px" height="100px" width="200px" alt=""></a>
						<div class="pad">
