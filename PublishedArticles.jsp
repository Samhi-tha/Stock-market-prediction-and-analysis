		...
		<div class="wrapper">
			<div class="wrapper">
				<ul class="banners">
					...
					<li>
						<a href="#"><img src="https://www.bing.com/th?id=OIP.XL3kKtVIJxlBWpbLaLzmKwHaFA&w=150&h=101&c=8&rs=1&qlt=90&o=6&dpr=1.4&pid=3.1&rm=2" height="100px" width="100px" alt=""></a>
						<div class="pad">
					...
					<li>
						<a href="#"><img src="https://th.bing.com/th/id/OIP.tu5yvoyO5oYFWYzLVOf-BwHaHa?rs=1&pid=ImgDetMain" height="100px" width="100px" height="100px" width="100px" height="100px" width="200px" alt=""></a>
						<div class="pad">
			...
			<div class="wrapper">
                            <font size="16" style="margin-left:500px;">Published Article</font>
...
try{
    ...
    ResultSet rs=st.executeQuery("select * from publish");
   while(rs.next()){  %>
   
   <tr>
       <td><%=rs.getString(2)%></td>
       <td><textarea cols="30" rows="5"><%=rs.getString(3)%></textarea></td>
