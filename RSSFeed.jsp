	...
	<section id="content">
		<div class="wrapper">
			<div class="wrapper">
                            ...
                            <center> <h4 style="color:orange;">RSS(Really Simple Syndication) Feed</h4></center>
                            <table  style="margin-left:200px;">
                                
                                <tr>
                                
                                <th style="background-color:green; color:whitesmoke;">Published By</th>
                                <th style="background-color:green; color:whitesmoke;">Company Name</th>
                                <th style="background-color:green; color:orange;">Description</th>
                                
                                <th style="background-color:green;color:orange;">Quality</th>
                                ...
                                <%try{
                                 ...
                                 ResultSet rs=st.executeQuery("select * from publish  order by quality  desc");
                                 while(rs.next()){%>
                                 <tr>
                                     <td><%=rs.getString(1)%></td>
                                     <td><%=rs.getString(2)%></td>
                                     
                                     <td><textarea cols="30" rows="3"><%=rs.getString(3)%></textarea></td>
