	...
	<header>
		...
		<nav>
			<ul id="menu">
				...
				<li style="list-style-type:none;"><a href="StockLogin.jsp"><span><span>Stock</span></span></a></li>
...
<!-- content -->
	<section id="content">
		<div class="wrapper">
			<div class="wrapper">
                            <center><h2>Welcome To Article Register</h2></center>
				<form name="company" action="ArticleRegAction.jsp" method="post">
                                                            <table bgcolor="orange" align="center" cellpadding="5px" border="5px">
                                                                <tr><td>Article Name</td><td><input type="text" name="companyname" required=""></td></tr>
                                                                <tr><td>Password</td><td><input type="password" name="password" required=""></td></tr>
                                                          <tr><td>Register ID</td><td><input type="text" name="id" required=""></td></tr> 
                                                           <tr><td>Article Type</td><td><input type="text" name="type" required=""></td></tr> 
