		...
		<div class="wrapper">
			<div class="wrapper">
				<ul class="banners">
					...
					<li>
						<a href="#"><img src="https://th.bing.com/th?id=OIP.lBM_nujXJIVWMv2F61So2wHaHa&w=250&h=250&c=8&rs=1&qlt=90&o=6&dpr=1.4&pid=3.1&rm=2" height="100px" width="200px" alt=""></a>
						<div class="pad">
...
ResultSet rs=st.executeQuery("select * from comregister where status='waiting'");
while(rs.next()){
     String status=rs.getString("status");%>
                                                        <tr><td><%=rs.getString(1)%></td>
                                                        <td><%=rs.getString(2)%></td>
                                                        <td><%=rs.getString("companytype")%></td>
                                                        <td><%=rs.getString("turnover")%></td>
                                                        
                                                        <%if(status.equals("waiting")){%>
                                                        <td><a href="DecideShareValue.jsp?companyname=<%=rs.getString(1)%>&id=<%=rs.getString(2)%>">Divide Share</a></td>
                                                        <%}else{%>
