...
<!-- header -->
	<header>
		<div class="wrapper">
			<h1><a href="index.html" id="logo"><image src="images/Designer.png"/></a></h1>
	...
	<section id="content">
		<div class="wrapper">
			<div class="wrapper">
                            ...
                            %>
                            <table>
                                <tr><td><font color="6">Hello&nbsp;&nbsp;<%=username%> your purchased company share value <br/>
                                        may be <font color="green">increase</font> by &nbsp;&nbsp;<%=value3%>Rs/-</font></td></tr>
                            </table>
			</div>
			<div class="wrapper">
