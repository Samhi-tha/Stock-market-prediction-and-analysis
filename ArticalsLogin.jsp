...
<!-- content -->
	<section id="content">
		<div class="wrapper">
			<div class="wrapper">
                            <center><h2>Welcome To Articles Login</h2></center>
				<form name="company" action="ArticleLoginAction.jsp" method="post">
                                                            <table bgcolor="orange" align="center" cellpadding="5px" border="5px">
                                                                 
                                                                <tr><td>Article Name</td><td><input type="text" name="articlename" required=""></td></tr> 
                                                                <tr><td>password</td><td><input type="password" name="password" required=""></td></tr> 
                                                             <tr><th><td><input type="Submit" value="Login" > <input type="Reset"> </td></tr> 
                                                             <tr><td><font color="red">New User ?</font></td><td><a href="ArtcleRegister.jsp">Register Here</a></td></td></tr>
                                                            </table>
                                                        </form>
			</div>
			<div class="wrapper">
