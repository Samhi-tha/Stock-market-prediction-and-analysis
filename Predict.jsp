		...
		<div class="wrapper">
			<div class="wrapper">
                            ...
                            <table border="1" style="margin-left: 300px;border:1px solid black;">
                                ...
                                ResultSet r=s.executeQuery("select * from purchaseshare where buyer='"+username+"'");
                                while(r.next()){
                                 ...
                                 <tr>
                                     ...
                                     <td><a style="text-decoration:none;" href="PredictAction.jsp?companyname=<%=r.getString(2)%>"><input type="submit" value="Predict"></a></td>
                                 </tr>
                                 <%}
