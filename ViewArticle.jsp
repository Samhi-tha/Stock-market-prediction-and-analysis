	...
	<section id="content">
		<div class="wrapper">
			<div class="wrapper">
                            ...
                            <table border="1" style="border:1px solid black;margin-left:200px;">
                                <tr>
                                <th>Company Name</th>
                                <th>Description</th>
                                ...
                                <%try{String companyname1=(String)session.getAttribute("companyname");
                                    String companyname=request.getParameter("company");
                                  Connection con=databasecon.getconnection();
                                 Statement st=con.createStatement(); 
                                 ResultSet rs=st.executeQuery("select * from publish where companyname='"+companyname+"' or companyname='"+companyname1+"'");
                                 while(rs.next()){%>
                                 <tr>
                                     ...
                                     <td><a href="Comment.jsp?artclename=<%=rs.getString(1)%>&companyname=<%=rs.getString(2)%>&companyid=<%=rs.getString(9)%>">Comment</a></td>
                                 </tr>
                                 <%}
                                }catch(Exception e){
                                  out.println(e);  
