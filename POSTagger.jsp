	...
	<section id="content">
		<div class="wrapper">
			<div class="wrapper">
                            ...
                            <h2 style="margin-left:380px;">POS Tagger</h2>
                            <table  style="margin-left:300px;">
                                
                                <tr>
                                    <th style="background-color:green; color:whitesmoke;">Article Name</th>
                                <th style="background-color:green; color:whitesmoke;">Company Name</th>
                                <th style="background-color:green; color:whitesmoke;">Comment</th>
                                <th style="background-color:green; color:whitesmoke;">Date</th>
