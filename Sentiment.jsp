	...
	<section id="content">
		<div class="wrapper">
			<div class="wrapper">
                            ...
                            <center> <h4 style="color:orange;">Sentiment Analysis</h4></center>
                            <table  style="margin-left:200px;">
                                ...
                                <th style="background-color:green; color:orange;">Positive</th>
                                <th style="background-color:green;color:orange;">Negative</th>
                                <th style="background-color:green;color:orange;">Neutral</th>
